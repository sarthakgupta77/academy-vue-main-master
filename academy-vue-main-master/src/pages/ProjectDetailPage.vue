<template>
  <q-page class="q-py-md">
    <div class="row" style="width: 100%">
      <div
        class="offset-lg-2 offset-md-2 offset-sm-2 col-lg-9 col-md-9 col-sm-9 col-12 q-pa-sm"
      >
        <div class="row" style="width: 100%">
              ...
              <div class="row">
                      ...
                      <div class="widget-container">
                        <div>
                          <p>
                            ...
                            >
                            <q-chip
                              v-if="data.status == 'Action Required'"
                              class="project-color3"
                              text-color="white"
                              size="sm"
                              >{{ data.status }}</q-chip
                            >
                            <q-chip
                              ...
                              class="project-color4"
                              text-color="white"
                              size="sm"
                              >{{ data.status }}</q-chip
                            >
                            <q-chip
                              v-if="data.status == 'Evaluated'"
                              class="project-color5"
                              text-color="white"
                              size="sm"
                              >{{ data.status }}</q-chip
                            >
                          ...
                          <p>
                            <q-chip outline color="red" size="sm"
                              >Due Date:
                              {{
                        ...
                        <div class="download-files">
                          ...
                          <ul>
                            ...
                            >
                              <a
                                :href="
                                  `https://datatrained.com/admin/public/` +
                                  file.path
                                "
                                target="_blank"
                                >{{ file.file_name }}</a
                ...
                <div class="col-md-4 col-sm-12">
                  <div class="chat-box">
                    ...
                    <div
                      v-if="data.status == 'Evaluated' && data.published == 1"
                      class="score"
                    >
                    ...
                    <div class="chat">
                      ...
                      <div class="row justify-center chatbox">
                          ...
                          <div>
                            ...
                            >
                              <q-fab-action
                                ...
                                label="Upload File"
                              />
                              <!-- <q-fab-action label-position="left" color="secondary" icon="assignment"
                                label="Make Submission" @click="makeSubmissionBox" /> -->
                            </q-fab>
                            <q-btn
                              :disable="
                                data.chatMsg && data.chatMsg.length > 0
                                  ? false
                                  : true
                              "
                              @click="sendMessage"
                        ...
                        <!-- <div v-if="data.submissionBox == true"
                          class="manage-box full-width flex column items-center justify-center q-pa-md">
                          <div class="q-mb-xl full-width">
                            <q-btn @click="revokeSubmissionBox" icon="arrow_back_ios" size="sm" flat
                              label="Back" class="q-mb-md" />
                          </div>
                          <q-form class="full-width">
                            <q-file outlined v-model="file" size="xs" dense color="indigo" class="q-mb-md"
                              label="Choose File">
                              <template v-slot:prepend>
                                <q-icon name="attach_file" />
                              </template>
                            </q-file>
                            <q-input v-model="text" outlined color="indigo" type="textarea" label="Enter Your Answer"
                              dense class="q-mb-md" size="xs" />
                            <q-btn color="indigo" type="submit" label="Submit" dense class="q-px-lg" />
                          </q-form>
                        </div> -->
                      </div>
                    </div>
                    <div v-if="data.evaluated == 0" class="manage">
                      <div class="title-box">Make Project Submission</div>
                      <div v-if="data.submission == 1">
                        <q-chip color="teal" text-color="white" icon="bookmark">
                          Project Submitted ,  Please Wait for the Evaluation.
                        </q-chip>
                      </div>
                      <div
                        class="manage-box full-width flex column items-center justify-center q-pa-md"
                    ...
                    <div v-else class="manage">
                      <div class="title-box">
                        ...
                        Project Files Submitted And Evaluated Successfully,
        ...
        if (res.data.msg == "File Uploaded") {
          ...
          api2
            .post("save-project-chat", {
              ...
              type: 1,
              student_msg:
                '<a href="https://genesis.datatrained.com/admin/public' +
                res.data.path +
                '" target="_blank">' +
                res.data.name +
                "</a>",
          ...
          api2
            ...
            .then((res) => {
              ...
              for (let i = 0; i < data.scoreData.length; i++) {
                data.maxMarks =
                  data.maxMarks + parseInt(data.scoreData[i].max_marks);
                data.obtainedMarks =
                  data.obtainedMarks +
                  parseInt(data.scoreData[i].obtained_marks);
              }
            });
        });
    });
